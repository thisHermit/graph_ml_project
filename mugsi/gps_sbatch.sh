...
#SBATCH --output=/mnt/lustre-grete/projects/LLMticketsummarization/muneeb/rand_dir/MuGSI/new/logs/gml_teacher_knowledge_pt_all.txt
...
cd /mnt/lustre-grete/projects/LLMticketsummarization/muneeb/rand_dir/MuGSI/new
