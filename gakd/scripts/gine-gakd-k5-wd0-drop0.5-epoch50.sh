#!/bin/bash
#SBATCH --job-name=gine-gakd-k5-wd0-drop0.5-epoch50
#SBATCH --partition=grete-h100
#SBATCH -G H100:1
#SBATCH --cpus-per-task=64
#SBATCH --ntasks=1
#SBATCH --time=1-23:55:00
#SBATCH --output=/mnt/lustre-grete/projects/LLMticketsummarization/muneeb/rand_dir/GakD/logs/gine-gakd-k5-wd0-drop0.5-epoch50.txt
...
python gakd.py --teacher_knowledge_path $TEACHER_KNOWLEDGE_PATH --epochs 50 --batch_size 32 --n_runs 1 --student_virtual_node false --student_optimizer_weight_decay 0 --student_dropout 0.5 --discriminator_update_freq 5