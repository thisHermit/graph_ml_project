...
def load_dataset_master(format, name, dataset_dir):
    ...
    # GraphGym default loader for Pytorch Geometric datasets
        ...
        if name.startswith("ogbg"):
            ...
            cfg.dataset.num_nodes = dataset.num_nodes
            cfg.dataset.num_graphs = len(dataset)
            cfg.dataset.num_tasks = dataset.num_tasks
...
def preformat_OGB_Graph(dataset_dir, name):
    ...
    dataset = PygGraphPropPredDataset(
        name=name, root=dataset_dir, pre_transform=_transform
    )
